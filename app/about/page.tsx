...
export default function AboutPage() {
  return <><SiteHeader /><main className="about-page section-shell">
    ...
    <section className="about-intro"><div className="about-big">白<br />胡<br />子</div><div><h2>为股民把复杂产业研究清楚</h2><p>白胡子研究院面向个人投资者，长期记录 AI 产业链、A股市场复盘和交易认知。每个主题都继续落到产业链位置、相关上市公司、业绩传导、催化窗口、风险和跟踪指标。</p><p>主理人广路用普通投资者听得懂的语言解释研究，但不把观点包装成事实，不把产业空间直接等同于上市公司的订单、收入或利润。</p></div></section>
