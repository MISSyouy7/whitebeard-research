...
export const metadata: Metadata = { title: "研究档案", description: "浏览白胡子研究院的公开全文与知识星球试读。" };

export default function ArticlesPage() {
  const articles = getAllArticles();
  return (
    <><SiteHeader /><main className="archive-page section-shell">
      <header className="page-masthead"><p>RESEARCH ARCHIVE / {String(articles.length).padStart(3, "0")}</p><h1>研究档案</h1><span>公开全文与星球试读，都按同一套研究边界记录。</span></header>
      ...
      <div className="archive-summary"><span>共收录 {articles.length} 篇</span><span>红色标记区分公开全文与星球专享</span></div>
